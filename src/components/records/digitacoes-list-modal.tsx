                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-6 pb-12">
                  {digitacoes.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-10 text-center">
                      <div className="flex size-16 items-center justify-center rounded-full bg-zinc-100 mb-4">
                        <Keyboard className="size-8 text-zinc-400" />
                      </div>
                      <p className="text-base font-medium text-zinc-900">Nenhuma digitação</p>
                      ...
                      {sortedOperators.map(([operator, items]) => (
                        <div key={operator} className="space-y-3">
                          <div className="flex items-center justify-between">
                            <h3 className="text-sm font-semibold text-zinc-700">{operator}</h3>
                          ...
                          <div className="space-y-2">
                            {items.map((dig) => (
                              <button
                                ...
                                className="w-full group flex items-center justify-between rounded-xl border border-zinc-200 bg-white p-3 text-left transition hover:border-zinc-300 hover:shadow-sm"
                              >
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="text-sm font-medium text-zinc-900">{dig.clientName}</p>
