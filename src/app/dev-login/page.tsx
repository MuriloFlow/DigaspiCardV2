        ...
        {!showForm ? (
          ...
          >
            ...
            <p className="mt-4 text-[15px] font-medium text-[#a1a1aa]">
              ...
              <span className="text-[#B19FFC]"> Acesso Exclusivo TI</span>
            </p>
          ...
          >
            <div className="mb-10 text-center">
              <div className="mx-auto mb-6 flex h-24 items-center justify-center text-rose-500 drop-shadow-[0_0_20px_rgba(244,63,94,0.3)]">
                <ShieldAlert className="size-16" />
              </div>
              <h2 className="text-[1.5rem] font-bold tracking-tight text-[#ffffff]">Acesso TI</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="group relative w-full rounded-full bg-gradient-to-r from-rose-500 via-rose-600 to-rose-500 p-[1px] shadow-[0_0_30px_-10px_rgba(244,63,94,0.4)] transition-all hover:shadow-[0_0_50px_-10px_rgba(244,63,94,0.6)] active:scale-[0.98] disabled:opacity-50"
              >
                <div className="flex h-[52px] w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-rose-500 via-rose-600 to-rose-500 text-[15px] font-bold text-[#ffffff] tracking-wide">
                  {isLoading ? <Loader2 className="size-5 animate-spin" /> : "Validar Credenciais"}
                </div>
              </button>
            </form>
          </motion.div>
